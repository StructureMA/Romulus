...
const userData = {
  ...
  projects: {
    ...
    cinnamon: { status: 'active', type: 'mobile', notes: 'Reference architecture for Expo apps', accounts: { default: 'jonathan@cinnamon.news' } },
    ...
    continuum: { status: 'active', type: 'mobile', notes: 'Active — currently building', accounts: {} },
